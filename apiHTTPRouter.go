...
func HTTPAPIServer() {
	...
	*/
	...
	if Storage.ServerHTTPDemo() {
		...
		public.GET("/play", HTTPAPIPlayBasic)
		public.GET("/play/audio", HTTPAPIPlayAudioBasic)
	}
...
func HTTPAPIPlayBasic(c *gin.Context) {
	c.HTML(http.StatusOK, "basic_player.tmpl", gin.H{
		"port":    Storage.ServerHTTPPort(),
		"streams": Storage.Streams,
		"version": time.Now().String(),
		"page":    "play_basic",
